...
<div class="pc-details-info">
    ...
    <div style="display: flex; gap: 15px; margin-top: 30px;">
        <button class="btn" onclick="addToCart('${name}', ${price}, 'prebuilt'); closePCDetails();">Добавить в корзину</button>
        <button class="btn btn-secondary" onclick="closePCDetails()" style="display: flex; align-items: center; justify-content: center;">Закрыть</button>
    </div>
</div>
`;
...
function showPaymentSuccess(lastFourDigits) {
    const successHTML = `
        <div style="text-align: center; padding: 40px 20px;">
            ...
            <button class="btn" onclick="closePaymentSuccess()" style="width: 100%;">
